<template>
  <footer class="footer sm:footer-horizontal bg-base-200 text-base-content p-10">
    ...
    <nav>
      <h1 class="footer-title">{{$t('component.footer.services')}}</h1>
    ...
    <nav>
      <h1 class="footer-title">{{$t('component.footer.company')}}</h1>
    ...
    <nav>
      <h1 class="footer-title">{{$t('component.footer.legal')}}</h1>
