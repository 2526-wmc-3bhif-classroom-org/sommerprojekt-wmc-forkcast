  ...
  <div class="container mx-auto px-4 py-24 flex justify-center">
    <div class="card-body">
      ...
      <section>
        ...
        <p>{{$t('privacy-policy.contact.email_label')}}<a href="mailto:n.haider@students.htl-leonding.ac.at" class="link link-primary">n.haider@students.htl-leonding.ac.at</a>
        </p>
      </section>
    </div>
  </div>
