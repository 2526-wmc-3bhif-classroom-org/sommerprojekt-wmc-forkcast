    ...
    <div class="hero h-screen
      ...
      <div class="hero-content flex-col lg:flex-row">
        <div>
          ...
          <nuxt-link-locale to="/auth/register" class="btn btn-primary mr-2 opacity-0 animate-fade-in">
            <i class="fa-solid fa-user-plus mr-1"/>
            Start Planning Free
          </nuxt-link-locale>
          <nuxt-link-locale to="/auth/login" class="btn btn-outline opacity-0 animate-fade-in">
